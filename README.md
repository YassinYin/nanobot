...
| `tools.allowedDirs` | `[]` | Allowlist of directories for tool access. When set, it **overrides** `restrictToWorkspace` and only permits paths inside the listed directories. |
